...
import 'package:sample_app/models/chat_room_info.dart';
...
class ChatService {
  ...
  Future<void> addChatList(String id, String title) async {
    ...
    if (chatRoomInfo.exists) {
      ...
      ChatRoomInfo newRoomInfo = ChatRoomInfo(
        imgUrl:
            'https://images.unsplash.com/photo-1577563908411-5077b6dc7624?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80',
        title: title,
        lastMessage: '',
  ...
  StreamTransformer documentToChatRoomInfoTransformer =
