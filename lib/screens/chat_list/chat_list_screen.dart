...
import 'package:sample_app/blocs/chat_list_bloc/chat_list_bloc.dart';
import 'package:sample_app/blocs/chat_room_bloc/chat_room_bloc.dart';
import 'package:sample_app/models/user.dart';
import 'package:sample_app/screens/chat_list/chat_list_item.dart';
import 'package:sample_app/screens/chat_room/chat_room_screen.dart';
                ...
                Navigator.of(context).push(MaterialPageRoute(builder: (_) {
                  return BlocProvider(
                    create: (_) => ChatRoomBloc(
                        user: user, title: state.chatList[index].title)
                      ..add(ChatRoomLoad()),
